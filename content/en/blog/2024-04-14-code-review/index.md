...
走味的 code review 大致會出現以下幾種 anti-pattern。
...
- `PowerOff` method name should be renamed to `TurnPowerOff`.

Code review 是知識傳遞與彼此溝通想法的過程，其中必然有溝通的藝術成分，這點需要放在心上，以免因為忙碌而忘了基本的尊重和禮貌。當然啦，接受建議的那一方，也不要過於敏感，或者太過容易感到冒犯。如果是建設性的建議，保持開放的心胸與對方討論，虛心學習，會是比較好的。
